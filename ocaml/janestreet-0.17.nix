...
in {
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "base";
          rev = "6ddf3438c79184fa443727058b623ccfe1d82ead";
          hash = "sha256-C663R3rVT5iK970EE2UFeV3fAHPB8AMN9os+zeVNFwE=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "base_bigstring";
          rev = "48cb145e676ee3dafda2cca71f8a88ed7028abb0";
          hash = "sha256-+2NvkBLDuiv1TnaXLHDxcLVD7IDliwZ+zz/FVEBnoMA=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "bin_prot";
          rev = "15cc8f7ed75510b426968f24a82807d0c6f5c3d2";
          hash = "sha256-603k+Z/mGmjs1+K+ogp3qhCcGG6WX5bky01lQuufPEg=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "core";
          rev = "6779e91a54dc7b30105a9730366d19be5371f2f1";
          hash = "sha256-F4ZUVeHldzgATNX79JT3lWVmPrOmOV5HLdkCLTUDt3U=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "memtrace";
          rev = "3789a1f741dbc6b804218d678708bc41d966e2ff";
          hash = "sha256-kwGlGU1jn13erFR+ll9QF65EPqL68tAQQqfF7QTiIpk=";
        };
    });
  ...
  #         rev = "a5301081d2b249b4dc7a596d85494e09f7940447";
  #         hash = "sha256-qWHL5k10kQfxPWMC5wB7/p7zykoKAVkSIl71MFEhhS0=";
  #     };
  #   });
  ...
  ocaml-compiler-libs =
    ...
    (_: {
      patches =
        if isFlambda2
        then [./flambda2-compiler-libs.patch]
        else [];
    });
    ...
    .overrideAttrs (o: {
      src =
        ...
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "ppx_bin_prot";
          rev = "457452b9ccc77ad300cf71adc9f403021db8c259";
          hash = "sha256-S/p+VmxouWpnJMPftQsscT6tkywmDBjKPjDx1PnUuSU=";
        };
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "ppx_diff";
          rev = "eebb67b723e9159e36f8d4f6aa52e3d0a569f84f";
          hash = "sha256-MK3uvNabqW6r+s2HSIM1zo84kG7WYMMxFx5Z6xiAYT8=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "ppx_globalize";
          rev = "0ae65ff681346ffde1216fcca7d9ab2bfa8319ba";
          hash = "sha256-0tEQAGeNv/UqK+20IVkGuQgJh8szxehlxPfcjnwB77Y=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "ppx_jane";
          rev = "68a91406168b637c698101a9a03556e2abc2b83c";
          hash = "sha256-QLHgbekfNH954tJ1WYqSDBHLJibT3VPEnRMklY41GBs=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "ppx_sexp_conv";
          rev = "d62e3a3f54306542696c89586f2fc1bf6e2187e6";
          hash = "sha256-ZrhpJ79a1ze3yzzOEC1bkRmYRs4FwdPRdie6MDhtY2A=";
        };
    });
  ...
  ppxlib_jane =
    ...
    .overrideAttrs (o: {
      nativeBuildInputs = [nixpkgs.legacyPackages."aarch64-darwin".git] ++ o.nativeBuildInputs;
      src =
        fetchFromGitHub
        {
          owner = "dialohq";
          repo = "ppxlib_jane";
          rev = "14cf4bd37c310cdc81955eec961a7795c75a274a";
          hash = "sha256-3pQOF704tnm09LAI8q0rCMnDGwIYlyInb3XbOhxK6vw=";
        };
    });
    ...
    .overrideAttrs (o: {
      src =
        fetchFromGitHub
        {
          owner = "janestreet";
          repo = "sexplib0";
          rev = "0ac31c25e9c2111085546d5b9b0c83ed446aa9bd";
          hash = "sha256-DAIuqW2QnWpSu5xStxSTs6lYkFVCLf2xQvCuudAHTJc=";
        };
    });
  ...
  typerep =
    ...
    .overrideAttrs (o: {
      ...
      src = fetchFromGitHub {
        owner = "dialohq";
        repo = "typerep";
        rev = "19548de9588ea5556ad90f61da9dd20bf81123b0";
        hash = "sha256-wNCpqJbCUdDseIjAJ/pmQa4Q1Gse3Ay/rfi8cAfnDm0=";
      };
    });
